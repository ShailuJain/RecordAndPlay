...
{
    public class VKStringMappings
    {
        public static Dictionary<VirtualKeys, String> vkStringMappings;
        static VKStringMappings()
        {
            vkStringMappings = new Dictionary<VirtualKeys, string>() {
                ...
                {VirtualKeys.Help, "{HELP}" },
                {VirtualKeys.Home, "{HOME}" },
                {VirtualKeys.Insert, "{INSERT}" },
                {VirtualKeys.Left, "{LEFT}" },
                {VirtualKeys.NumLock, "{NUMLOCK}" },
                {VirtualKeys.Next, "{PGDN}" },
                {VirtualKeys.Prior, "{PGUP}" },
                {VirtualKeys.Snapshot, "{PRTSC}" },
                ...
                {VirtualKeys.F24, "{F24}" },
                {VirtualKeys.Add, "{ADD}" },
                {VirtualKeys.Subtract, "{SUBTRACT}" },
                {VirtualKeys.Multiply, "{MULTIPLY}" },
                {VirtualKeys.Divide, "{DIVIDE}" },
                {VirtualKeys.Shift, "+" },
